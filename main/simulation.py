...
class Simulation:
    def __init__(self, n_type, seed=None, limits=(100, 100, 0)) -> None:
        ...
        self.boid_vel_z = np.zeros_like(self.boid_acc_x, dtype=np.float32)
        ...
        self.d_boid_acc_z = cuda.to_device(self.boid_acc_z)
        self.d_boid_vel_x = cuda.to_device(self.boid_vel_x)
        self.d_boid_vel_y = cuda.to_device(self.boid_vel_y)
        self.d_boid_vel_z = cuda.to_device(self.boid_vel_z)
