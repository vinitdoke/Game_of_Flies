            ...
            if num_bin_z < 1:
                ...
                for k in range(num_bin_z):
                    ...
                    if k == 0:
                        ...
                        kp1 = 0
                    bin_neighbours[
                        i + j * num_bin_x + k * num_bin_x * num_bin_y, 0] = i + j * num_bin_x + k * num_bin_x * num_bin_y
                    bin_neighbours[
                        i + j * num_bin_x + k * num_bin_x * num_bin_y, 1] = ip1 + j * num_bin_x + k * num_bin_x * num_bin_y
                    bin_neighbours[
                        i + j * num_bin_x + k * num_bin_x * num_bin_y, 2] = im1 + jp1 * num_bin_x + k * num_bin_x * num_bin_y
                    bin_neighbours[
                        i + j * num_bin_x + k * num_bin_x * num_bin_y, 3] = i + jp1 * num_bin_x + k * num_bin_x * num_bin_y
                    bin_neighbours[
                        i + j * num_bin_x + k * num_bin_x * num_bin_y, 4] = ip1 + jp1 * num_bin_x + k * num_bin_x * num_bin_y

                    bin_neighbours[
                        i + j * num_bin_x + k * num_bin_x * num_bin_y, 5] = ip1 + j * num_bin_x + kp1 * num_bin_x * num_bin_y
                    bin_neighbours[
                        i + j * num_bin_x + k * num_bin_x * num_bin_y, 6] = im1 + j * num_bin_x + kp1 * num_bin_x * num_bin_y
                    bin_neighbours[
                        i + j * num_bin_x + k * num_bin_x * num_bin_y, 7] = i + jp1 * num_bin_x + kp1 * num_bin_x * num_bin_y
                    bin_neighbours[
                        i + j * num_bin_x + k * num_bin_x * num_bin_y, 8] = i + jm1 * num_bin_x + kp1 * num_bin_x * num_bin_y
                    bin_neighbours[
                        i + j * num_bin_x + k * num_bin_x * num_bin_y, 9] = ip1 + jp1 * num_bin_x + kp1 * num_bin_x * num_bin_y
                    bin_neighbours[
                        i + j * num_bin_x + k * num_bin_x * num_bin_y, 10] = ip1 + jm1 * num_bin_x + kp1 * num_bin_x * num_bin_y
                    bin_neighbours[
                        i + j * num_bin_x + k * num_bin_x * num_bin_y, 11] = im1 + jp1 * num_bin_x + kp1 * num_bin_x * num_bin_y
                    bin_neighbours[
                        i + j * num_bin_x + k * num_bin_x * num_bin_y, 12] = im1 + jm1 * num_bin_x + kp1 * num_bin_x * num_bin_y
                    bin_neighbours[
                        i + j * num_bin_x + k * num_bin_x * num_bin_y, 13] = i + j * num_bin_x + kp1 * num_bin_x * num_bin_y
                ...
                if i != j:
                    ...
                    if (1e-10 < dist) and (dist < r_max * r_max):
                        ...
                        if parameter_matrix[-1, p1, p2] == 0:
                            ...
                            cuda.atomic.add(acc_z, i, -acc * (pos_z[i] - pos_z_2) / dist)
                        elif parameter_matrix[-1, p1, p2] == 1:
                            acc = boids(
                                dist, pos_x_2 - pos_x[i], pos_y_2 - pos_y[i], pos_z_2 - pos_z[i],
                            ...
                            cuda.atomic.add(boid_vel_z, p2 * num_particles + i, vel_z[j])
                        ...
                        if bin2 != particle_bins[i]:
                            if parameter_matrix[-1, p2, p1] == 0:
                                ...
                                cuda.atomic.add(acc_z, j, acc * (pos_z[i] - pos_z_2) / dist)
                                ...
                                cuda.atomic.add(boid_acc_z, p1 * num_particles + j, pos_z_1)
                                cuda.atomic.add(boid_vel_x, p1 * num_particles + j, vel_x[i])
                                cuda.atomic.add(boid_vel_y, p1 * num_particles + j, vel_y[i])
                                cuda.atomic.add(boid_vel_z, p1 * num_particles + j, vel_z[i])
    cuda.syncthreads()
    ...
    if i < num_particles:
        ...
        for j in range(num_types):
            ...
            if parameter_matrix[-1, p1, j] == 1 and c > 0:
                ...
                spd = (vel_x[i] * vel_x[i] + vel_y[i] * vel_y[i] + vel_z[i] * vel_z[i]) ** 0.5
                if spd > 10:
